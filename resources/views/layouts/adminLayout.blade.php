        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse ml-3" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto  ">
                    ...
                    <li class="nav-item tracking-wider mx-2 my-auto">
                        <a href="{{ route('allSchedule') }}">
                            <i class="fa fa-calendar-minus-o" style="font-size:18px"></i>

                            Schedule
                        </a>
                    </li>
                    <li class="nav-item tracking-wider mx-2 my-auto">
                        <a href="{{ route('allAnnouncement') }}">
                            <i class='fas fa-paint-roller' style='font-size:18px'></i>
